...
class _ReservationFormState extends State<ReservationForm> {
  ...
  final int _peopleCount = 1;
  
  static const int _maxCapacity = 40;
  final int _currentOccupancy = 0; // TODO: load this for the selected time slot
  ...
  void _submit() {
      Future<void> submit() async { // Make sure to add 'async' here
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('reservations').add({
        ...
        // You should also add the specific user's ID here later!
        // 'userId': currentUser.uid, 
      });

      // --- NEW BACKEND CODE ENDS HERE ---
