...
class WarmupPlansPage extends StatefulWidget {
  final bool isInstructor;
  const WarmupPlansPage({super.key, this.isInstructor = false});

  @override
  State<WarmupPlansPage> createState() => _WarmupPlansPageState();
}

class _WarmupPlansPageState extends State<WarmupPlansPage> {
  ...
  void _showAddDialog() {
    ...
    String iconName = 'accessibility_new';
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDialogState) => AlertDialog(
          ...
          title: const Row(
            children: [
              Icon(Icons.add_circle_rounded, color: Color(0xFFFF9800)),
              SizedBox(width: 8),
              Text('Add Warm-up Plan'),
            ],
          ),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                await _firestore.collection('warmupPlans').add({
  ...
  Future<void> _deletePlan(String docId, String title) async {
    ...
    if (confirmed == true) {
      await _firestore.collection('warmupPlans').doc(docId).delete();
    }
  }
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                widget.isInstructor
                                    ? 'No plans yet.\nTap + to add one!'
                                    : 'No warm-up plans available yet.',
